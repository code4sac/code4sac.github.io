...
(function($){
	$.fn.calendarGrid = function(options){
		...
		var defaults = {
			...
			showHolidays: true,
			weekStart: '1',
			sAjaxSource: 'http://www.google.com/calendar/feeds/developer-calendar@google.com/public/full?alt=json-in-script&callback=insertAgenda&orderby=starttime&max-results=15&singleevents=true&sortorder=ascending&futureevents=true
'
		};
